        ...
        <q-card>
            ...
            <q-card-section class="col-12">
                <q-form @submit="onSubmit" class="q-gutter-md">
                    <q-input outlined v-model="form.nome" label="Nome" lazy-rules :dense="dense"
                        :rules="[(val) => val.length > 0 || 'Nome é obrigatório']" />
                    <q-input outlined v-model="form.ultimaAlteracao" label="Última Alterção" lazy-rules :dense="dense"
